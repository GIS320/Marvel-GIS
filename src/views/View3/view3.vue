<template>
    <div>
        ...
        <video v-if="this.showVideo" id="filmCut" class="filmCut"  autoplay loop
                ...
                map.on('load', () => {
                    map.addLayer(new MapboxLayer({
                        ...
                        onHover: ({object, x, y}) => {
                            ...
                            if (object) {
                                el.innerHTML = `<p style="text-align: center">取景地:${object.name}</p><img src="${require("../../assets/img/event_picture/"+ object.name +".png")}" style="vertical-align: middle" width="500"><br>电影:${object.film}<br>取景地描述:${object.text1}<br>涉及电影情节:${object.text2}</br>`;
